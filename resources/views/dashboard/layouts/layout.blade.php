...
<header class="navbar">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav pull-left hidden-md-down">
            ...
            <li class="nav-item dropdown" style="margin-left: 15px !important">
                <a class="nav-link nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-gear fa-lg m-t-2" style="display: inline"></i>  <span class="hidden-md-down">{{ __('words.Setting') }}</span></a>
                <div class="dropdown-menu dropdown-menu-right">
                    <div class="dropdown-header text-xs-center">
                        <strong>{{ __('words.Setting') }}</strong>
                    </div>
                    <a class="dropdown-item" href="{{ route('dashboard.users.edit', auth()->user()) }}"><i class="fa fa-user"></i> {{ __('words.user setting') }}</a>
                    <div class="divider"></div>
                    <a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault();
                       document.getElementById('logout-form').submit();">{{ __('words.logout') }}
                    </a>
...
<footer class="footer">
    <a href="http://coreui.io" target="_blank"> <span class="text-left">كورس انشاء مدونة إلكترونية&copy; 2022.</span></a>
</footer>
...
<script src="https://kit.fontawesome.com/9f06570580.js" crossorigin="anonymous"></script>
<!-- CoreUI main scripts -->
